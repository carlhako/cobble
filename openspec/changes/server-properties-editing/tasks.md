...
- [x] 8.5 Run the full check suite — `ruff check . && ruff format --check .`, `pytest`, `npm --prefix web run lint`, `npm --prefix web run test`, `npm --prefix web run build` — and verify all pass
