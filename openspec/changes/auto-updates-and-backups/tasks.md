...
- [ ] 12.1 Verify the migration on a live LXC carrying a real world: backup taken, world relocated, server starts against the separated layout with the world intact and players able to rejoin
